...
func create_session(
	...
	print(
		...
		" | Stats STR B/A/P: ",
		session.primary_stats.base_strength,
		"/",
		session.primary_stats.allocated_strength,
		"/",
		session.primary_stats.permanent_strength,
		" | AGI B/A/P: ",
		session.primary_stats.base_agility,
		"/",
		session.primary_stats.allocated_agility,
		"/",
		session.primary_stats.permanent_agility,
		" | VIT B/A/P: ",
		session.primary_stats.base_vitality,
		"/",
		session.primary_stats.allocated_vitality,
		"/",
		session.primary_stats.permanent_vitality,
		" | ENE B/A/P: ",
		session.primary_stats.base_energy,
		"/",
		session.primary_stats.allocated_energy,
		"/",
		session.primary_stats.permanent_energy,
		" | Stat Points: ",
